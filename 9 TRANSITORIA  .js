...
// stage content:
(lib._9TRANSITORIA = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
// library properties:
lib.properties = {
	id: '35345ACCE7564340AE6E3D23F33FF994',
	width: 1920,
	height: 1080,
	fps: 30,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/Mapadebits3.png?1698940006862", id:"Mapadebits3"}
	],
	preloads: []
};
...
an.compositions['35345ACCE7564340AE6E3D23F33FF994'] = {
