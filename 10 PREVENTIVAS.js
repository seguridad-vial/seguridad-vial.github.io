...
p.nominalBounds = new cjs.Rectangle(0,0,2056,1264);
...
// stage content:
(lib._10PREVENTIVAS = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(-61,-97);
...
p.nominalBounds = new cjs.Rectangle(899,443,1096,724);
// library properties:
lib.properties = {
	id: '32CA367AAA684441B686BCB292FFA717',
	width: 1920,
	height: 1080,
	fps: 30,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/Mapadebits5.png?1698939350471", id:"Mapadebits5"}
	],
	preloads: []
};
...
an.compositions['32CA367AAA684441B686BCB292FFA717'] = {
